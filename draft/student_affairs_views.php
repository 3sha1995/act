...
<section class="student_affairs_functions_section">
    <div class="student_affairs_functions_container">
        ...
        <div class="student_affairs_functions_content">
            ...
            <ul class="student_affairs_functions_list">
                <li>Providing primary healthcare services including consultations, first aid, and treatment for common illnesses and injuries</li>
                <li>Dispensing prescribed medications and providing information on proper medication use and potential side effects</li>
                <li>Conducting health screenings, physical examinations, and health status evaluations for students and employees</li>
                <li>Offering counseling services, stress management programs, and referrals for psychological support</li>
                <li>Organizing workshops, seminars, and information campaigns on various health topics and preventive measures</li>
                <li>Providing immediate care for emergencies and coordinating with external healthcare providers for advanced treatment</li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="student_affairs_services_grid">
            ...
            <div class="student_affairs_service_card">
                ...
                <div class="student_affairs_service_content">
                    ...
                    <div class="student_affairs_service_steps">
                        <div class="step_item">
                            <div class="step_bullet"></div>
                            <div class="step_text">Book dental check-up</div>
                        </div>
                        <div class="step_item">
                            <div class="step_bullet"></div>
                            <div class="step_text">Oral examination</div>
                        </div>
                        <div class="step_item">
                            <div class="step_bullet"></div>
                            <div class="step_text">Treatment procedure</div>
                        </div>
                        <div class="step_item">
                            <div class="step_bullet"></div>
                            <div class="step_text">Follow-up visit</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="student_affairs_service_card">
                ...
                <div class="student_affairs_service_content">
                    ...
                    <div class="student_affairs_service_steps">
                        <div class="step_item">
                            <div class="step_bullet"></div>
                            <div class="step_text">Request test</div>
                        </div>
                        <div class="step_item">
                            <div class="step_bullet"></div>
                            <div class="step_text">Sample collection</div>
                        </div>
                        <div class="step_item">
                            <div class="step_bullet"></div>
                            <div class="step_text">Laboratory analysis</div>
                        </div>
                        <div class="step_item">
                            <div class="step_bullet"></div>
                            <div class="step_text">Result interpretation</div>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="student_affairs_timeline_section">
    <div class="student_affairs_timeline_container">
        <div class="student_affairs_timeline_header">
            <h2 class="student_affairs_timeline_title">ACTIVITIES CALENDAR</h2>
            <div class="student_affairs_timeline_subtitle">Recent and upcoming student affairs events</div>
            <div class="student_affairs_timeline_divider"></div>
        </div>
        
        <div class="student_affairs_timeline_wrapper">
            <div class="timeline_items_container">
                <!-- Item 1: Recent -->
                <div class="timeline_item" data-date="2023-08-10">
                    ...
                    <div class="timeline_card">
                        <div class="timeline_badge recent">Recent</div>
                        <div class="timeline_image">
                            <img src="../imgs/cte.jpg" alt="Freshman Orientation Seminar">
                        </div>
                        <div class="timeline_content">
                            <h3 class="timeline_title">Freshman Orientation Seminar</h3>
                            <p class="timeline_description">Comprehensive orientation program for new students covering academic policies, campus resources, and student life.</p>
                            <div class="timeline_details">
                                <div class="timeline_detail"><i class="fas fa-map-marker-alt"></i> University Auditorium</div>
                                <div class="timeline_detail"><i class="fas fa-clock"></i> 8:00 AM - 5:00 PM</div>
                ...
                <!-- Item 2: Today -->
                <div class="timeline_item" data-date="2023-08-15">
                    <div class="timeline_date">
                        <span class="date_month">AUG</span>
                    ...
                    <div class="timeline_card">
                        <div class="timeline_badge today">Today</div>
                        <div class="timeline_image">
                            <img src="../imgs/cte-field.png" alt="Student Leadership Conference">
                        </div>
                        <div class="timeline_content">
                            <h3 class="timeline_title">Student Leadership Conference</h3>
                            <p class="timeline_description">Annual conference focusing on developing leadership skills among student organization officers and aspiring leaders.</p>
                            <div class="timeline_details">
                                <div class="timeline_detail"><i class="fas fa-map-marker-alt"></i> Conference Center</div>
                                <div class="timeline_detail"><i class="fas fa-clock"></i> 9:00 AM - 4:00 PM</div>
                ...
                <!-- Item 3: Upcoming -->
                <div class="timeline_item" data-date="2023-08-20">
                    <div class="timeline_date">
                        <span class="date_month">AUG</span>
                    ...
                    <div class="timeline_card">
                        <div class="timeline_badge upcoming">Upcoming</div>
                        <div class="timeline_image">
                            <img src="../imgs/cte.jpg" alt="Career Development Workshop">
                        </div>
                        <div class="timeline_content">
                            <h3 class="timeline_title">Career Development Workshop</h3>
                            <p class="timeline_description">Workshop focused on resume building, interview skills, and job search strategies for graduating students.</p>
                            <div class="timeline_details">
                                <div class="timeline_detail"><i class="fas fa-map-marker-alt"></i> Career Services Center</div>
                                <div class="timeline_detail"><i class="fas fa-clock"></i> 1:00 PM - 5:00 PM</div>
                ...
                <!-- Item 4: Upcoming -->
                <div class="timeline_item" data-date="2023-09-05">
                    <div class="timeline_date">
                    ...
                    <div class="timeline_card">
                        ...
                        <div class="timeline_content">
                            <h3 class="timeline_title">Wellness Week</h3>
                            <p class="timeline_description">Week-long event featuring health screenings, fitness activities, mental health workshops, and nutritional counseling.</p>
                            <div class="timeline_details">
                                <div class="timeline_detail"><i class="fas fa-map-marker-alt"></i> Various Campus Locations</div>
                                <div class="timeline_detail"><i class="fas fa-calendar-week"></i> September 5-9, 2023</div>
                ...
                <!-- Item 5: Recent -->
                <div class="timeline_item" data-date="2023-08-05">
                    <div class="timeline_date">
                        <span class="date_month">AUG</span>
                        <span class="date_day">05</span>
                        <span class="date_year">2023</span>
                    ...
                    <div class="timeline_card">
                        ...
                        <div class="timeline_content">
                            <h3 class="timeline_title">Cultural Diversity Celebration</h3>
                            <p class="timeline_description">Annual event showcasing cultural performances, international cuisine, and interactive displays representing diverse cultures.</p>
                            <div class="timeline_details">
                                <div class="timeline_detail"><i class="fas fa-map-marker-alt"></i> University Plaza</div>
                                <div class="timeline_detail"><i class="fas fa-clock"></i> 11:00 AM - 7:00 PM</div>
        ...
        <div class="student_affairs_timeline_footer">
...
<script>
    // Timeline date categorization
    document.addEventListener('DOMContentLoaded', function() {
        // Define the date categorization function
        function categorizeDates() {
            ...
            timelineItems.forEach(item => {
                ...
                // Set the badge based on date
                if (itemDate.getTime() === today.getTime()) {
                    item.querySelector('.timeline_badge').textContent = 'Today';
                    item.querySelector('.timeline_badge').className = 'timeline_badge today';
                } else if (itemDate < today) {
                    item.querySelector('.timeline_badge').textContent = 'Recent';
                    item.querySelector('.timeline_badge').className = 'timeline_badge recent';
                } else {
                    item.querySelector('.timeline_badge').textContent = 'Upcoming';
                    item.querySelector('.timeline_badge').className = 'timeline_badge upcoming';
                }
        ...
        // Call the function to set initial categories
        categorizeDates();
        ...
        // Initialize animation with all items initially visible
        const timelineItems = document.querySelectorAll('.timeline_item');
        timelineItems.forEach((item, index) => {
            setTimeout(() => {
                item.style.opacity = "1";
        ...
        // Run animation check on scroll for any newly loaded items
